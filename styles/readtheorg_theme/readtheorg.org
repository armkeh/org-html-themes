...
code{
    /* background:#fff;
       border:solid 1px #e1e4e5;  armkeh: removed to improve appearance of inline code */ 
...
.tag span {
    ...
    color: #000; /* #939393;  armkeh: black text on near white is more readable. */
    cursor: pointer;
    /* display: block;
       float: right;  armkeh: the floating block leaves an empty bit of background on the left; ugly. */
    font-size: 80%;
    font-weight: normal;
    margin: 0 3px;
    padding: 1px 2px;
